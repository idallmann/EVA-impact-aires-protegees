...
save_dir = paste("projet-afd-eva-ap/impact_analysis/matching", Sys.Date(), sep = "/")
...
log = fn_pre_log(list_iso,
                 name = paste0("log-", Sys.Date(), "-test-COM.txt"),
                 notes = "The branch matching_auto has been merged to main. This is a test to check everything is fine.")
