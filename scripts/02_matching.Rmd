...
install.packages(c("tictoc", "geodata", "wdpar", "exactextractr", "MatchIt", "fixest", "cobalt", "future", "progressr", "mapme.biodiversity", "future.callr"))
...
for (i in list_iso)
{
  ...
  tic_parallel = tic()
  ###ATTENTION : J4AI REMPLACE %<-% par = DANS calc_indicators : a modifier
