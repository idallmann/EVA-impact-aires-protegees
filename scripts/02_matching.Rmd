...
#gridSize = 10000 
n_sampling = 1000 #CAREFUL : DIVIDED BY 5 FOR GAB only !!!
...
#Define data_pa as this
data_pa = data_pa_fapbm
...
log = fn_pre_log(list_iso,
                 name = paste0("log-", Sys.Date(), "-FAPBM.txt"),
                 notes = "Study of PA funded by FAPBM")
