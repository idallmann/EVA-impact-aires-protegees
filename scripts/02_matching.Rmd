...
install.packages(c("tictoc", "geodata", "wdpar", "exactextractr", "MatchIt", "fixest", "cobalt", "future", "progressr", "mapme.biodiversity", "future.callr", "janitor", "geomtextpath"))
...
#save_dir = paste("impact_analysis/matching", "2023-08-XX", sep = "/")
...
list_iso = list_iso_africa[1:8]
# list_iso = list_iso_africa[9:16]
# list_iso = list_iso_africa[17:24]
...
log = fn_pre_log(list_iso,
                 name = paste0("log-", Sys.Date(), "-afrcia-full.txt"),
                 notes = "Attempt to perform full analysis on Africa PAs.")
