...
##Load
wdpa_wld_raw = s3write_using(
              sf::st_read,
              object = paste0("data_raw/wdpa/wdpa_shp_global.gpkg"),
              bucket = "projet-afd-eva-ap",
              opts = list("region" = ""))
...
for (i in list_iso)
{
  ...
  #Generate a README.txt file to sum up the PAs considered in the the country
  print("--Genereate README file")
