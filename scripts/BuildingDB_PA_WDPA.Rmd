...
data_iso = fread("00_data_raw/liste-197-etats-2020.csv") %>%
  rename("iso3" = "CODE",
         "nom_alpha" = "NOM_ALPHA") %>%
...
data_PA_raw = read_excel("00_data_raw/BDD_joint.xlsx") %>%
  as.data.frame()
...
data_PA_tidy = data_PA_raw %>%
  ...
  mutate(afd_bin = ifelse(cofinancier_1 == "AFD" | cofinancier_2 == "AFD" | cofinancier_3 == "AFD" |
                          cofinancier_4 == "AFD" | cofinancier_5 == "AFD" | cofinancier_6 == "AFD",
                          yes = TRUE, 
                          no = FALSE),
         afd_bin = ifelse(is.na(afd_bin), yes = FALSE, no = afd_bin),
...
list_var_siop_AP = c( "id_projet", "nom_du_projet", "nom_de_projet_pour_les_instances",
                      ...
                      "cofinancier_3","cofinancier_4", "cofinancier_5", "cofinancier_6", "afd",
                      "afd_bin", "kfw_bin", "ffem_bin", "cofin_other", "cofin_unkwn",
...
data_siop_AP = data_PA_tidy %>%
  select(all_of(list_var_siop_AP), iso3)
# write_csv(data_siop_AP, "C:/Users/vuillota/Desktop/projet_AiresProtegees/01_data_tidy/BDD_AP_SIOP_joint.xlsx")
...
list_var_PA = c("id_projet", "nom_du_projet", "nom_ap", "id_concours", 
                ...
                "montant_total_projet", "annee_octroi",
...
#fwrite(data_stat, "01_data_tidy/BDD_DesStat.csv")
...
#fwrite(data_stat_nodupl, "01_data_tidy/BDD_DesStat_nodupl.csv")
```
