# (PART\*) Miscellaneous statistics {.unnumbered}

# Specific groups of PAs
...
pie_cat_iucn_en = ggplot(data_cat_iucn, 
  ...
  + labs(x = "", y = "",
         ...
         subtitle = paste("Sample :", sum(data_cat_iucn$n_iucn), "protected areas funded by FAPBM")) %>%
...
pie_cat_iucn_ref_en = ggplot(data_cat_iucn_ref, 
  ...
  + labs(x = "", y = "",
         ...
         subtitle = paste("Sample :", sum(data_cat_iucn_ref$n_iucn), "out of", sum(data_cat_iucn$n_iucn),  "protected areas funded by FAPBM")) %>%
  + scale_fill_brewer(name = "Categories", palette = "Dark2") %>%
  + theme_void()
pie_cat_iucn_ref_en
...
for(f in files) 
  ...
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/IUCN/FAPBM/all", 
...
pie_cat_iucn_en = ggplot(data_cat_iucn, 
  ...
  + labs(x = "", y = "",
         title = "Distribution of protected areas by IUCN categories (%)",
         subtitle = paste("Sample :", sum(data_cat_iucn$n_iucn), "protected areas in Madagascar")) %>%
  + scale_fill_brewer(name = "Categories", palette = "Dark2") %>%
  + theme_void()
pie_cat_iucn_en
...
pie_cat_iucn_ref_en = ggplot(data_cat_iucn_ref, 
  ...
  + labs(x = "", y = "",
         title = "Distribution of protected areas by IUCN categories \nexcluding not reported/categorized (%)",
         subtitle = paste("Sample :", sum(data_cat_iucn_ref$n_iucn), "out of", sum(data_cat_iucn$n_iucn),  "protected areas in Madagascar")) %>%
  + scale_fill_brewer(name = "Categories", palette = "Dark2") %>%
  + theme_void()
pie_cat_iucn_ref_en
...
for(f in files) 
  ...
  cat("Uploading file", paste0("'", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/IUCN/MDG/all", 
                     region = "", show_progress = TRUE)
  }
...
+ labs(title = "Proportion of protected areas by ecosystem type \n(excluding not referenced PAs)",
       subtitle = paste("Sample :", sum(data_eco_hist$n), "out of", nrow(data_pa_fapbm), "protected areas funded by FAPBM"),
         x = "Ecosystem type",
...
+ coord_polar("y", start=0) %>%
+ labs(title = "Proportion of protected areas by ecosystem type \n(excluding not referenced PAs)",
       subtitle = paste("Sample :", sum(data_eco_hist$n), "out of", nrow(data_wdpa_mdg), "protected areas in Madagascar"),
         x = "Ecosystem type",
         y = "Proportion of protected areas") %>%
  + scale_fill_brewer(name = "Ecosystem", palette="Paired") %>%
  + theme_void()
...
print(xtable(tbl_gov_knwn_en, 
             caption = "Governance of protected areas funded by FAPBM (when known)",
             type = "latex"),
...
for(f in files) 
{
  ...
  cat("Uploading file", paste0(count, "/", length(files), " '", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/gouvernance/FAPBM/all", 
                     region = "", show_progress = TRUE)
  }
...
print(xtable(tbl_gov_knwn_en, 
             caption = "Governance of protected areas in Madagascar (when known)",
             type = "latex"),
      file = paste(tmp, "tbl_gov_knwn_en.tex", sep  ="/"))
...
for(f in files) 
{
  ...
  cat("Uploading file", paste0(count, "/", length(files), " '", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/gouvernance/MDG/all", 
                     region = "", show_progress = TRUE)
  }
...
tbl_area_fapbm = data_pa_fapbm %>%
  summarize(n = n(),
            tot = format(sum(area_km2), big.mark = ",", digits = 1),
            min = format(min(area_km2), big.mark = ",", digits = 1),
            max = format(max(area_km2), big.mark = ",", digits = 1),
            mean = format(mean(area_km2), big.mark = ",", digits = 1)
            )
...
print(xtable(tbl_area_fapbm, 
             caption = "Statistics on protected areas funded by FAPBM",
             type = "latex"), 
...
for(f in files) 
{
  ...
  cat("Uploading file", paste0(count, "/", length(files), " '", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/surface/FAPBM", 
                     region = "", show_progress = TRUE)
  }
...
tbl_area_mdg = data_wdpa_mdg %>%
  summarize(n = n(),
            tot = format(sum(rep_area), big.mark = ",", digits = 1),
            min = format(min(rep_area), big.mark = ",", digits = 1),
            max = format(max(rep_area), big.mark = ",", digits = 1),
            mean = format(mean(rep_area), big.mark = ",", digits = 1)
            )
...
print(xtable(tbl_area_mdg, 
             caption = "Statistics on protected areas in Madagascar",
             type = "latex"), 
...
for(f in files) 
{
  ...
  cat("Uploading file", paste0(count, "/", length(files), " '", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/surface/MDG", 
                     region = "", show_progress = TRUE)
  }
