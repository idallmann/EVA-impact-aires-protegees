...
1. Compare the CRS of "gadm" and "gadm_prj". To do so you can just enter the name of the object in the console to get information about it. 
...
To this end this section first downloads protected area (PA) polygons from WDPA and reprojects them to the same projection used previously. After some filtering and cleaning of PA polygons, a buffer is created around each one of them. Then, each polygon is assigned to a group (group 1 for funded Pas, group 2 for unfunded Pas and group 3 for buffer zones).
