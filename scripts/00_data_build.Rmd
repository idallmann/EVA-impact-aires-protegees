...
#Create a dataset gathering EVA and ARB datasets
...
data_siop = read_excel("data_raw/BO_AP_16082023.xlsx") %>%
  ...
  mutate(pays_de_realisation = simpleCap(pays_de_realisation),
         autres_pays_de_realisation = simpleCap(autres_pays_de_realisation))
