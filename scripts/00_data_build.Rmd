...
data_PA_tidy = data_PA_raw %>%
  ...
  #French related : a particular iso is created : "FRA_XXX" with XXX assignment to the territory it corresponds. 
  #Ocen Indien let NA value, Muti-pays set to ZZ as in the SIOP dataset
  mutate(iso3 = case_when(
    pays == "Mayotte" ~ "FRA_MAY",
    pays == "Nouvelle-Caledonie" ~ "FRA_NLC",
    pays == "Polynesie Francaise" ~ "FRA_PNF",
