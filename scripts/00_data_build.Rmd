...
data_tidy = data_raw_corr %>%
  ...
  mutate(country_fr = case_when(pays_siop %in% c("P-N N.Caléd", "P-S N.Caléd", "Nlle Caledonie") | iso3 == "NCL" ~ "Nouvelle-Caledonie",
                               ...
                               iso3 == "MYT" ~ "Mayotte",
                               pays_siop %in% c("Multi-Pays", "Multi-pays") ~ "Multi-pays",
                               TRUE ~ country_fr)) %>%
    mutate(country_en = case_when(pays_siop %in% c("P-N N.Caléd", "P-S N.Caléd", "Nlle Caledonie")  | iso3 == "NCL"  ~ "New Caledonia",
                                  ...
                                  iso3 == "MYT" ~ "Mayotte",
                                  pays_siop %in% c("Multi-Pays", "Multi-pays") ~ "Multi-countries",
                                  TRUE ~ country_en)) %>%
  #Some entries in "pays_siop" are French department, DROM-COM, "Ocean Indien" or   #"Multi-Pays".
