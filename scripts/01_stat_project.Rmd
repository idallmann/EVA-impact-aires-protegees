...
In general, PAs refer to AFD funded PAs. When all PAs reported through the world are considered (typically for comparative statistics between general PAs and AFD funded PAs), it will be precised.
...
+ labs(title = "Top countries of non-marine protected areas (#)",
       ...
       caption = "Note : we consider non-marine PAs reported by the WDPA on the full period covered by the data.\nA subset of it is AFD funded, though some PAs funded by the AFD are not reported by the WDPA.",
         x = "",
         y = "Share of protected areas (%)") %>%
