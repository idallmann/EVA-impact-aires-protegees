...
+ labs(title = "Distribution of AFD funded protected areas by country",
       subtitle = paste("Sample :", sum(filter(data_distrib_ctry, metric == "n")$value), "protected areas covering", format(sum(filter(data_distrib_ctry, metric == "area_km2")$value), digits = 2, scientific = TRUE), "km²"),
         x = "",
         y = "Share of protected areas (%)") %>%
+ scale_fill_brewer(name = "", labels = c("Surface", "Number"),
...
+ labs(title = "Top countries of non-marine protected areas",
       subtitle = paste("Sample :", min(data_distrib_ctry_wdpa$n_tot_wdpa), "non-marine protected areas reported by WDPA, covering", format(min(data_distrib_ctry_wdpa$area_km2_wdpa_tot), scientific = TRUE, digits = 2), "km²"),
       caption = "Note : we consider non-marine PAs reported by WDPA on the full period covered by the data.\nA subset of it is AFD funded, though some PAs funded by the AFD are not reported by the WDPA.",
         x = "",
         y = "Share of protected areas (%)") %>%
+ scale_fill_brewer(name = "", labels = c("AFD funded", "All"),
                    type = "seq", palette = "Blues") %>%
  + theme(legend.position = "bottom",
      legend.key = element_rect(fill = "white"),
      plot.title = element_text(size = 14, face = "bold"), 
...
+ labs(title = "Top countries of AFD funded, non-marine protected areas",
       subtitle = paste("Sample :", min(data_distrib_ctry_afd$n_tot_afd), "non-marine protected areas reported by WDPA, covering", format(min(data_distrib_ctry_afd$area_km2_afd_tot), scientific = TRUE, digits = 2), "km²"),
       caption = "Note : we consider non-marine PAs reported by WDPA on the full period covered by the data.\nA subset of it is AFD funded, though some PAs funded by the AFD are not reported by the WDPA.",
         x = "",
         y = "Share of protected areas (%)") %>%
+ scale_fill_brewer(name = "", labels = c("AFD funded", "All"),
...
+ labs(title = "Top countries targeted by AFD funded non-marine protected areas",
       subtitle = paste("Sample :", min(data_distrib_ctry_wdpa$n_tot_wdpa), "non-marine protected areas reported by WDPA,",  min(data_distrib_ctry_afd$n_tot_afd), "funded by AFD"),
       caption = "Note : we consider non-marine PAs reported by WDPA on the full period covered by the data.\nA subset of it is AFD funded, though some PAs funded by the AFD are not reported by the WDPA.",
         x = "",
         y = "Share of protected areas (%)") %>%
+ scale_fill_brewer(name = "", labels = c("AFD funded", "All"),
...
#         vjust = -0.1, color="black",
#         size=3) %>%
+ labs(title = "Distribution of non-marine protected areas by region",
...
+ labs(title = "Distribution of non-marine protected areas across regions",
       subtitle = paste("Sample :", min(data_distrib_reg_wdpa$n_tot_wdpa), "non-marine protected areas reported by WDPA,",  min(data_distrib_reg_afd$n_tot_afd), "funded by AFD"),
       caption = "Note : we consider non-marine PAs reported by WDPA on the full period covered by the data.\nA subset of it is AFD funded, though some PAs funded by the AFD are not reported by the WDPA.",
         x = "",
         y = "Share of protected areas (%)") %>%
+ scale_fill_brewer(name = "", labels = c("AFD funded", "All"),
...
+ geom_bar(position="dodge", stat="identity", na.rm = TRUE) %>%
+ labs(title = "Distribution of non-marine protected areas across regions",
       subtitle = paste("Sample :", min(data_distrib_reg_wdpa$n_tot_wdpa), "non-marine protected areas reported by WDPA -", format(min(data_distrib_reg_wdpa$area_km2_wdpa_tot), scientific = TRUE, digits = 2), "km² - \nand",  min(data_distrib_reg_afd$n_tot_afd), "funded by AFD -", format(min(data_distrib_reg_afd$area_km2_afd_tot) , scientific = TRUE, digits = 2), "km² -"),
       caption = "Note : we consider non-marine PAs reported by WDPA on the full period covered by the data.\nA subset of it is AFD funded, though some PAs funded by the AFD are not reported by the WDPA.",
         x = "",
         y = "Share of areas (%)") %>%
+ scale_fill_brewer(name = "", labels = c("AFD funded", "All"),
