...
data_stat_nodupl_old = 
  #fread("data_tidy/old/BDD_nofund.csv" , encoding = "UTF-8")
  aws.s3::s3read_using(
  FUN = data.table::fread,
  encoding = "UTF-8",
  # Mettre les options de FUN ici
  object = "data_tidy/old/BDD_nofund.csv",
  bucket = "projet-afd-eva-ap",
  opts = list("region" = ""))
...
for(f in files) 
  ...
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/IUCN", 
...
for(f in files) 
{
  ...
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/ecosysteme", 
                     region = "", show_progress = TRUE)
  }
