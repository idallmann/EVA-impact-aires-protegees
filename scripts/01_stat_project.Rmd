...
#### Share of PAs by IUCN categories (world)
...
for(f in files) 
{
  ...
  cat("Uploading file", paste0(count, "/", length(files), " '", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/distribution", 
                     region = "", show_progress = TRUE)
  }
...
for(f in files) 
{
  ...
  cat("Uploading file", paste0(count, "/", length(files), " '", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/surface", 
                     region = "", show_progress = TRUE)
  }
...
fig_n_pa_fr = ggplot(data_time_n,
  ...
  + labs(title = "Nombre d'aires protégées appuyées par année par l'AFD",
         subtitle = paste("Echantillon :", sum(data_time_n$n), "sur", nrow(data_stat_nodupl), "aires protégées"),
         x = "Année",
...
fig_n_pa_en = ggplot(data_time_n,
  ...
  + labs(title = "Number of protected areas funded each year by AFD",
         subtitle = paste("Sample :", sum(data_time_n$n),  "out of", nrow(data_stat_nodupl), "protected areas"),
         x = "Year",
...
for(f in files) 
{
  ...
  cat("Uploading file", paste0(count, "/", length(files), " '", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/time_evolution", 
                     region = "", show_progress = TRUE)
  }
...
fig_area_pa_fr = ggplot(data_time_area,
  ...
  + labs(title = "Evolution de la superficie financée par l'AFD",
         subtitle = paste("Echantillon :", sum(data_time_n$n), "aires protégées sur",  nrow(data_stat_nodupl), "couvrant", format(sum(data_time_area$tot_area_noint_km2), digits = 1, scientific = FALSE, big.mark = " "), "km2"),
         x = "Année",
         y = "Superficie (km2)") %>%
  + theme(legend.position = "bottom",
      legend.key = element_rect(fill = "white"),
...
fig_area_pa_en = ggplot(data_time_area,
  ...
  + labs(title = "Evolution of AFD funded area",
         subtitle = paste("Sample :", sum(data_time_n$n), "protected areas out of", nrow(data_stat_nodupl), "covering", format(sum(data_time_area$tot_area_noint_km2), digits = 1, scientific = FALSE, big.mark = " "), "km2"),
         x = "Year",
         y = "Area (km2)") %>%
  + theme(legend.position = "bottom",
      legend.key = element_rect(fill = "white"),
...
pie_gov_knwn_en = 
  ...
  + geom_label(aes(x=1.3, 
               ...
               size=2.5, show.legend = FALSE) %>%
  + coord_polar("y", start=0) %>%
  + labs(title = "Governance type of PAs, except not referenced/reported",
         subtitle = paste("Sample :", sum(data_gov_knwn_en$n), "PAs out of", nrow(data_stat_nodupl))) %>%
...
pie_gov_knwn_fr =
  ...
  + geom_label(aes(x=1.3, 
               ...
               size=2.5, show.legend = FALSE) %>%
  + coord_polar("y", start=0) %>%
  + labs(title = "Gouvernance, hors non-rapportée/référencée",
         subtitle = paste("Echantillon :", sum(data_gov_knwn_fr$n), "aires protégées sur", nrow(data_stat_nodupl))) %>%
...
for(f in files) 
{
  ...
  cat("Uploading file", paste0(count, "/", length(files), " '", f, "'"), "\n")
  aws.s3::put_object(file = f, 
                     bucket = "projet-afd-eva-ap/descriptive_stats/gouvernance", 
                     region = "", show_progress = TRUE)
  }
