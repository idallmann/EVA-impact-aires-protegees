...
ggplot() +
  ...
  geom_sf(data = data_map_focus, aes(fill = iso3)) +  # Polygones de zones protégées
  ...
  theme(panel.grid.major = element_line(color = gray(.5), linetype = "dashed", size = 0.1), panel.background = element_rect(fill = "grey85"),legend.position = c(0.95, 0.13),legend.text = element_text(size = 6), legend.key.size = unit(0.3, 'cm'),legend.title = element_text(size = 7),
