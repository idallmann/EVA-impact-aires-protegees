...
#save_dir = paste("impact_analysis/did", "2023-10-2", sep = "/")
...
n_final_noaca = length(unique(df_fc_att_tidy_aca$wdpaid))
n_final_noaca_focus = length(unique(filter(df_fc_att_tidy_noaca, focus == T)$wdpaid))
```
