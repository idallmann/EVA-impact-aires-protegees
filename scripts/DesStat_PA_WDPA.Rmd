...
data_stat = 
  #fread("data_tidy/BDD_DesStat.csv")
  aws.s3::s3read_using(
...
data_stat_nodupl = 
  ...
  FUN = data.table::fread,
  # Mettre les options de FUN ici
  object = "data_tidy/BDD_DesStat_nodupl.csv",
  bucket = "projet-afd-eva-ap",
  opts = list("region" = ""))
data_stat_nodupl_utf8 = 
...
base_nodupl_lea = 
  readxl::read_xlsx("data_tidy/base_nodupl_lea.xlsx")
  aws.s3::s3read_using(
  FUN = readxl::read_xlsx,
  # Mettre les options de FUN ici
  object = "data_tidy/base_nodupl_lea.xlsx",
  bucket = "projet-afd-eva-ap",
  opts = list("region" = ""))
...
base_nodupl_old = 
  ...
  FUN = data.table::fread,
  # Mettre les options de FUN ici
  object = "data_tidy/base_nodupl_old.csv",
  bucket = "projet-afd-eva-ap",
  opts = list("region" = ""))
...
bdd_joint = 
  #readxl::read_xlsx("data_raw/BDD_joint.xlsx")
  aws.s3::s3read_using(
  FUN = readxl::read_xlsx,
  # Mettre les options de FUN ici
