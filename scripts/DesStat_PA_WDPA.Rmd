...
data_stat_utf8 = fread("data_tidy/BDD_DesStat.csv", encoding = "UTF-8")
...
data_stat_nodupl_utf8 = fread("data_tidy/BDD_DesStat_nodupl.csv" , encoding = "UTF-8")

base_nodupl_lea = readxl::read_xlsx("data_tidy/base_nodupl_lea.xlsx")
base_nodupl_old = fread("data_tidy/base_nodupl_old.csv") 
projet_nodupl_old = readxl::read_xlsx("data_tidy/projet_nodupl_old.xlsx")

bdd_joint = readxl::read_xlsx("data_raw/BDD_joint.xlsx")
bdd_na = bdd_joint %>% filter(is.na(wdpaid))
```
