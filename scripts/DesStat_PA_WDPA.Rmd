...
3.  Then the intersection can be aggregated at country, region or world level. Then it is subtracted to the sum of areas at country, region or world level.
...
pa_shp = read_sf("00_data_raw/WDPA_SHP/BDD_SHP_nodupl.shp") %>%
  ...
  dplyr::select(c(wdpaid, sprfc, rep_a, gis_a, geometry, iso3, drct)) %>%
  mutate(area_sf = as.numeric(st_area(geometry)/1e6)) %>%
  #Project to Mollweide to compute relevant areas
  st_transform(crs = "+proj=moll +datum=WGS84") %>%
  #Compute areas in km2
  mutate(area_sf_moll = as.numeric(st_area(geometry)/1e6))

#Compute intersecting areas
pa_int = st_intersection(pa_shp, pa_shp) %>%
  ...
  #Compute the intersecting areas
  mutate(area_int = as.numeric(st_area(geometry)/1e6)) %>%
  #Now duplicates need to be removed : intersection of X with Y AND intersection of Y with X are reported
...
#       file = "C:/Users/Antoi/Desktop/projet_AiresProtegees/05_StatDes/IUCN/tbl_cat_iucn.tex")
...
#        path = "C:/Users/Antoi/Desktop/projet_AiresProtegees/05_StatDes/IUCN",
#        height = 6, width = 9)
...
#       file = "C:/Users/Antoi/Desktop/projet_AiresProtegees/05_StatDes/IUCN/tbl_iucn_ctry.tex")
# print(xtable(data_iucn_reg, type = "latex"), 
#       file = "C:/Users/Antoi/Desktop/projet_AiresProtegees/05_StatDes/IUCN/tbl_iucn_reg.tex")
...
# print(xtable(tbl_eco_world_fr, type = "latex"), file = "05_StatDes/ecosysteme/tbl_ecosyst_fr.tex")
...
# print(xtable(tbl_eco_world_en, type = "latex"), file = "05_StatDes/ecosysteme/tbl_ecosyst_en.tex")
...
#        path = "05_StatDes/time_evolution",
#        height = 6, width = 9)
