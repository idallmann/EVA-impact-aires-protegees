...
fig_fund_avg_dr = ggplot(data = data_fund_avg_dr,
  ...
  + labs(title = "Fonds moyens alloués aux projets par région",
         subtitle = paste("Echantillon :", sum(tbl_fund_avg_dr$n_proj), "projets. Nombre de projets indiqué sur les barres."),
          x = "", 
          y = "Montant (€)") %>%
...
fig_fund_tot_dr = ggplot(data = data_fund_tot_dr,
  ...
  + labs(title = "Total des fonds alloués aux projets par région",
         subtitle = paste("Echantillon :", sum(tbl_fund_tot_dr$n_proj), "projets. Nombre de projets indiqué sur les barres."),
          x = "", 
          y = "Montant (€)") %>%
  + theme(legend.position = "bottom",
      legend.key = element_rect(fill = "white"),
