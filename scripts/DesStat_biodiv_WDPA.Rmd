...
source("scripts/functions_DesStat_biodiv.R", encoding = "utf-8")
```
...
pa_shp = 
  ...
  # bucket = "vuillota",
  # opts = list("region" = "")) %>%
  #Check geometry are valid, and make it valid if not. Necessary to compute indicators in the polygons
  st_make_valid() %>%
  #transform multiploygons to polygons, supported by the mapme package (88 group of polygons to 152 single polygons)
...
pa_nodupl = fread("data_tidy/BDD_DesStat_nodupl.csv") %>%
...
#       dsn = "data_tidy/mapme_bio_data/pa_pfolio_forest.gpkg",
#       overwrite = FALSE)

pa_pfolio_forest = read_portfolio("data_tidy/mapme_bio_data/pa_pfolio_forest.gpkg")
...
#        "data_tidy/mapme_bio_data/data_pfolio_forest.csv")

data_pfolio_forest = fread("data_tidy/mapme_bio_data/data_pfolio_forest.csv")
...
#       dsn = "data_tidy/mapme_bio_data/pa_pfolio_mang.gpkg",
#       overwrite = FALSE)

pa_pfolio_mang = read_portfolio("data_tidy/mapme_bio_data/pa_pfolio_mang.gpkg")
...
#        "data_tidy/mapme_bio_data/data_pfolio_mang.csv")

data_pfolio_mang = fread("data_tidy/mapme_bio_data/data_pfolio_mang.csv")
