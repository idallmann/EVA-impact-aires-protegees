...
mf = s3read_using(sf::st_read,
                  ...
                  object = "data_tidy/mapme_bio_data/matching_frame_10km.gpkg",
                  opts = list("region" = "")) %>%
    filter(group==0 | group==1) %>%
    drop_na() #%>%
   #st_drop_geometry()
...
`cobalt` library naturally supports the visualization of `MatchIt` outputs, Reference: <https://cloud.r-project.org/web/packages/cobalt/vignettes/cobalt.html#bal.plot>
