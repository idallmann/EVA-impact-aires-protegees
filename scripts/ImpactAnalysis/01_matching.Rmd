...
toc_pre = toc()
duration_pre = tic_pre - toc_pre 

#NOTE : 
## the limiting step in terms of time is the final one, due to data downloading. Otherwise, a few seconds by country
## The gridding could depend on the country and the area of PAs. Indeed the sampling might be inappropriate if the PA area is lower the the pixel area.
## 
```
...
toc_post = toc()
duration_post = tic_post - toc_post
