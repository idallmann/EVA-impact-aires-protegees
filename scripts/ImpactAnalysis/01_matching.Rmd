...
#NOTE : 
## the limiting step in terms of time is the final one, due to data downloading. Otherwise, a few seconds by country. Especially computing time for forest indicators
## The gridding could depend on the country and the area of PAs. Indeed the sampling might be inappropriate if the PA area is lower the the pixel area. This cuases issue regarding significance. Or it could cause long computing time for large countries like China.
## 
```
