...
tbl_fc_africa = data_fc_africa %>%
  ...
  dplyr::select(c(country_en, iso3, n_wdpa, n_wdpa_ie, n_afd, n_afd_ie, area_wdpa_km2, area_wdpa_ie_km2, area_afd_km2, area_afd_ie_km2, fc_2010_per)) %>%
  mutate(country_en = case_when(iso3 == "MYT" ~ "Mayotte",
         ...
         area_afd_km2 = case_when(is.na(area_afd_km2) == TRUE ~ "/",
                                  is.na(area_afd_km2) == F ~ format(area_afd_km2, digit = 1, big.mark = ",", scientific = F)),
         area_wdpa_km2 = case_when(is.na(area_wdpa_km2) == TRUE ~ "/",
                                  is.na(area_wdpa_km2) == F ~ format(area_wdpa_km2, digit = 1, big.mark = ",", scientific = F)),
         area_afd_ie_km2 = case_when(is.na(area_afd_ie_km2) == TRUE ~ "/",
                                  is.na(area_afd_ie_km2) == F ~ format(area_afd_ie_km2, digit = 1, big.mark = ",", scientific = F)),
         area_wdpa_ie_km2 = case_when(is.na(area_wdpa_ie_km2) == TRUE ~ "/",
                                  is.na(area_wdpa_ie_km2) == F ~ format(area_wdpa_ie_km2, digit = 1, big.mark = ",", scientific = F)),
