...
data_fapbm_map=data_fapbm %>% dplyr::select("name","geometry","wdpaid","region","iso3") # for the GIE chapter we are adding FAPBM PAs
data_map= data_afd %>% dplyr::select("name_pa","geometry","wdpaid","region","iso3")%>% dplyr::rename(name=name_pa)
