...
data_afd_gie <- data_stat_nodupl %>% dplyr::select(region,marine,wdpaid,area_km2,year_funding_first)


data_fabm_gie<- data_pa_fapbm %>% dplyr::select(region,marine,wdpaid,area_km2)%>%
  mutate(year_funding_first=2005)



data_gie <- rbind(data_fabm_gie, data_afd_gie)
